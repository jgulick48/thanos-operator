...
func (q *Receive) serviceMonitor() (runtime.Object, reconciler.DesiredState, error) {
	if q.Thanos.Spec.Receive != nil && q.Thanos.Spec.Receive.Metrics.ServiceMonitor {
		metrics := q.Thanos.Spec.Receive.Metrics
